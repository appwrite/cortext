...
const COLLECTIONS = {
  ...
  blogs: {
    ...
    attributes: [
      ...
      { key: 'description', type: 'string', size: 2048, required: false, array: false, default: null },
      { key: 'domain', type: 'string', size: 255, required: false, array: false, default: null },
      { key: 'logo', type: 'string', size: 512, required: false, array: false, default: null },
      { key: 'favicon', type: 'string', size: 512, required: false, array: false, default: null },
      ...
      { key: 'socialLinks', type: 'string', size: 2000, required: false, array: false, default: null },
      { key: 'analyticsId', type: 'string', size: 255, required: false, array: false, default: null },
      { key: 'customCss', type: 'string', size: 50000, required: false, array: false, default: null },
      { key: 'customJs', type: 'string', size: 50000, required: false, array: false, default: null },
    ],
    indexes: [
      { key: 'name', type: 'key', attributes: ['name'] },
      { key: 'slug', type: 'unique', attributes: ['slug'] },
